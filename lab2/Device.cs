...
namespace lab2 {
  class Device: Electronics {
    ...
    public override void On() { Console.WriteLine("Device is switched on"); }
    public override void Off() { Console.WriteLine("Device is switched off"); }

    public void Mode() {
      if (isWorking) {
        // Console.WriteLine("Working mode: on");
        if (workingMode != null) { workingMode(this); }
      }
    }
