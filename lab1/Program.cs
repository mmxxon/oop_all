...
namespace lab1 {
  ...
  class Device {
    ...
    public int Year {
      ...
      set {
        if (value > 1900) { this.yearOfProducting = value; }
      }
    }
    public virtual void typeOfDevice() { Console.WriteLine(typeOfElectronics); }

    public void switchOn() { Console.WriteLine("Device is working"); }
    public enum Colors {
      none,
      silver,
      grey,
  ...
  class Phone: Device {
    public Phone() { Console.WriteLine("\nConstractor of the phone"); }
    // private int year;
    new public static string typeOfElectronics = "\nThis is a Phone";
    public override int deviceAge() { return 2020 - Year; }
    public enum Brand {
      none,
      Samsung,
      Apple,
  ...
  class Smartphone: Phone {
    ...
    public static Smartphone GetSmartphoneInstance() {
      if (SmartphoneInstance == null) { SmartphoneInstance = new Smartphone(); }
